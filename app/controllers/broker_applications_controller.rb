class BrokerApplicationsController < ApplicationController
  ...
  def set_broker_application
    @broker_application = BrokerApplication.includes(:broker_applicant, :broker_vehicle, :broker_finance, :broker_hp_agreement, :broker_purchase_invoice).find(params[:id])
  end
